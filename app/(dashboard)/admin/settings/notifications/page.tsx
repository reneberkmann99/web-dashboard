  ...
  return (
    <div className="space-y-6">
      ...
      <section>
        ...
        {destinationsQuery.isLoading ? <div className="h-32 animate-pulse rounded-lg bg-panelAlt" /> : destinations.length === 0 ? <div className="rounded-lg border border-border bg-panelAlt/40 p-5 text-sm text-muted">No destination configured. Noderaft still records logical notification events.</div> : <div className="grid gap-3 lg:grid-cols-2">{destinations.map((destination) => <div key={destination.id} className="rounded-lg border border-border bg-panel p-4">
