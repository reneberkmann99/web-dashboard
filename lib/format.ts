...
export function humanizeAction(action: string): string {
  ...
  const map: Record<string, string> = {
    ...
    EMAIL_SETTINGS_UPDATED: "Updated email settings",
    EMAIL_DELIVERY_ENABLED: "Enabled email delivery",
    EMAIL_DELIVERY_DISABLED: "Disabled email delivery",
    SMTP_TEST_SUCCEEDED: "SMTP test succeeded",
